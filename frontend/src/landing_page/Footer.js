    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/images/finora-logo.svg" style={{ width: "70%" }} />
            <p className="mt-3">
              &copy; 2010 - 2024, Not Finora Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <a href="#">Careers</a>
            <br />
            <a href="#">Finora.tech</a>
            <br />
            <a href="#">Press & media</a>
            <br />
            <a href="#">Finora cares (CSR)</a>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
